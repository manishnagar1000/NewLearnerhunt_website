      ...
      <Row>
        <Col>
          <h2 className="text-2xl font-bold mb-4">
            Privacy Policy for <b>Learnerhunt</b>
          </h2>

          <p className="my-1">
            At{" "}
            <b>
              <a href="https://learnerhunt.com/" className="text-blue-500">
                https://learnerhunt.com/
              </a>
            </b>
            , accessible from{" "}
            <b>
          ...
          <p className="my-1">
            ...
            that they shared and/or collected in{" "}
            <b>
              <a href="https://learnerhunt.com/" className="text-blue-500">
                https://learnerhunt.com/
              </a>
            ...
            <a href="https://privacypolicygenarator.info/">
              Fast & Free Privacy Policy Generator
            </a>
          </p>

          <h2 className="text-xl font-bold my-4">Consent</h2>
          ...
          <h2 className="text-xl font-bold my-4">Log Files</h2>
...
<h2 className="text-xl font-bold my-4">Third Party Privacy Policies</h2>
...
<p className="my-1">
  ...
  's Privacy Policy does not apply to other advertisers or websites. Thus,
...
<h2 className="text-xl font-bold my-4">GDPR Data Protection Rights</h2>
...
<h2 className="text-xl font-bold my-4">Children's Information</h2>
