    ...
    <div className="main_part">
        <section className="banner">
            <div className="banner_img">
                <img src="/assets/images/isbr/banner.jpg" className="img-fluid" alt="banner"/>
            </div>
            <div className="logo">
                <img src="/assets/images/isbr/logo.png" className="img-fluid" alt="logo"/>
            </div>
        ...
        <div className="form-sec" id="home" >
            <div className="form">
             <div className="npf_wgts" data-height="400px" data-w="c8afbc55b5ee7325aff665a310044845"></div>
                <div className="adm-txt" style={{color:"#c64327"}}><strong>Enquiry Now</strong></div>
                <div className="form-group Name">
                    <input type="text" className="input" name="name" id="name" placeholder="Name" value={name} onChange={(e)=>setName(e.target.value)} autoComplete="off"/>
                </div>
                <div className="form-group email">
                    <input type="email" className="input" name="email" id="email" placeholder="Email id " value={email} onChange={(e)=>setEmail(e.target.value)} autoComplete="off"/>
                </div>
                <div className="form-group Mobile">
                    <input type="number" className="input" name="mobile" id="mobile" placeholder="Phone" value={mobile} onChange={(e)=>setMobile(e.target.value)} autoComplete="off"/>
                </div>
                <div className="form-group State">
                    <select className="input" name="state" id="state" value={state}
                ...
                <div className="form-group City">
                    <select className="input" name="city" id="city"  value={city}
                ...
                <div className="form-group">
                    <select className="input" name="specialization" id="specialization" value={course} onChange={(e)=>setCourse(e.target.value)}>
                ...
                <div className="sb-btn-sec">
                    ...
                    <input type="button" className="sbt" id="apply_now" onClick={handleSumbit} value="Submit"/>
                    <span id="sbt"></span>
                </div>
            </div>
        </div>
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="heading_top ">
                            <h2>Move away from the ordinary<br/>
                                & <span>choose ISBR</span></h2>
                        </div>
                        <div className="move_slider">
                            <div className="item">
                                <div className="first_row">
                                    <div className="icon">
                                        <img src="/assets/images/isbr/icon-1.png" className="img-fluid" alt=""/>
                                        <p>Foundation<br/>
                                            Courses</p>
                                    </div>
                                    <div className="icon">
                                        <img src="/assets/images/isbr/icon-2.png" className="img-fluid" alt=""/>
                                        <p>Core<br/>
                                            Courses</p>
                                    </div>
                                    <div className="icon">
                                        <img src="/assets/images/isbr/icon-3.png" className="img-fluid" alt=""/>
                                        <p>Concentration<br/>
                                            Courses</p>
                                    </div>
                                    <div className="icon">
                                        <img src="/assets/images/isbr/icon-4.png" className="img-fluid" alt=""/>
                                        <p>Leadership<br/>
                                            Lab</p>
                                    </div>
                                </div>
                                <div className="first_row">
                                    <div className="icon">
                                        <img src="/assets/images/isbr/icon-5.png" className="img-fluid" alt=""/>
                                        <p>Finance <br/>
                                            Lab</p>
                                    </div>
                                    <div className="icon">
                                        <img src="/assets/images/isbr/icon-6.png" className="img-fluid" alt=""/>
                                        <p>Character<br/>
                                            Lab</p>
                                    </div>
                                    <div className="icon">
                                        <img src="/assets/images/isbr/icon-7.png" className="img-fluid" alt=""/>
                                        <p>International Guest<br/>
                                            Lecture Series</p>
                                    </div>
                                    <div className="icon">
                                        <img src="/assets/images/isbr/icon-8.png" className="img-fluid" alt=""/>
                                        <p>Life Skill<br/>
                                            Boot Camp</p>
                                    </div>
                                </div>
    ...
    <section className="academic">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="heading_top">
                        <h2><span>Academic</span> Initiatives</h2>
                    </div>
                    <div className="academic_slider">
                        <div className="item">
                            <div className="image_content">
                                <div className="image_part_acade">
                                    <img src="/assets/images/isbr/academic_img-6.jpg" className="img-fluid" alt=""/>
                                </div>
                                <p>Industry Demanded<br/>
                                    Career Courses</p>
                            </div>
                        </div>
                        <div className="item">
                            <div className="image_content">
                                <div className="image_part_acade">
                                    <img src="/assets/images/isbr/academic_img-7.jpg" className="img-fluid" alt=""/>
                                </div>
                                <p>Concentration courses-<br/>
                                    based on the JDs co-designed<br/>
                                    and co-taught by corporates</p>
                            </div>
                        </div>
                        <div className="item">
                            <div className="image_content">
                                <div className="image_part_acade">
                                    <img src="/assets/images/isbr/academic_img-8.jpg" className="img-fluid" alt=""/>
                                </div>
                                <p>Life Skill<br/>
                                    Boot Camps</p>
                            </div>
    ...
    <section className="recruiters">
        <div className="container">
            <div className="row">
                <div className="col-lg-12">
                    <div className="heading_top">
                        <h2>Key <span>Recruiters</span></h2>
                    </div>
                    <div className="move_slider">
                        <div className="item">
                            <div className="first_row">
                                <div className="icon">
                                    <img src="/assets/images/isbr/recruiter_img-17.png" className="img-fluid" alt=""/>
                              
                                </div>
                                <div className="icon">
                                    <img src="/assets/images/isbr/recruiter_img-18.png" className="img-fluid" alt=""/>
                            
                                </div>
                                <div className="icon">
                                    <img src="/assets/images/isbr/recruiter_img-19.png" className="img-fluid" alt=""/>
                    ...
                    <div className="slick-list draggable"><div className="slick-track" ><div className="item slick-slide slick-cloned"   id="" aria-hidden="true">
                            <div className="first_row">
                                <div className="icon">
                                    <img src="/assets/images/isbr/recruiter_img-17.png" className="img-fluid" alt=""/>
                                </div>
