...
const FilterComponent = ({
  ...
  const toggleDropdownMobile = (heading) => {
    ...
    let btnr = document.getElementById(`filter-box-btn-ratings`);
    let btnc = document.getElementById(`filter-box-btn-courses`);
    let btnd = document.getElementById(`filter-box-btn-ourcourses`);

    let filterDivI = document.getElementById(`filter-box-zones`);
    let filterDivII = document.getElementById(`filter-box-ratings`);
    let filterDivIII = document.getElementById(`filter-box-courses`);
    let filterDivIV = document.getElementById(`filter-box-ourcourses`);


    if(heading != 'OurCourses'){
    ...
    if(heading == 'OurCourses'){
      ...
      btnd.classList.remove(`${Classes.activeOurCourses}`);
      filterDivIV.classList.remove(`${Classes.mobileShowOurCourses}`);
    }
    ...
    } else if (heading == 'OurCourses'){
      btnd.classList.add(`${Classes.activeOurCourses}`);
      filterDivIV.classList.add(Classes.mobileShowOurCourses);
    }
  };
  const HandleChange = (e, data, type) => {
    setSearchData(false);
